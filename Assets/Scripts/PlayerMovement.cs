...
public class PlayerMovement : MonoBehaviour
{
    ...
    void MovePlayer()
    {
        ...
        float v = Input.GetAxis("Vertical"); // W + S / UP + DOWN : a vlaue between -1 and 1
        float h = Input.GetAxis("Horizontal"); // A + D / LEFT + RIGHT : a value between -1 + 1
        ...
        pawn.SimpleMove(speed); // Adds gravity for us
    }
}
